...
prompt = {'Enter number of targets','Enter number of Baseline movements:','Enter number of Experimental movements:','Enter number of Post movements:','Catch Trials'};
dlgtitle = 'Input';
dims = [1 50];
definput = {'4','50','100','50','true'};            %Default input values 
