...
for i=length(fields(TrainingMov.Direction1))-4:length(fields(TrainingMov.Direction1))
...
for i=length(fields(TrainingMov.Direction2))-4:length(fields(TrainingMov.Direction2))
    fname1=['Mff',num2str(i)];
...
for i=length(fields(TrainingMov.Direction3))-4:length(fields(TrainingMov.Direction3))
    fname1=['Mff',num2str(i)];
...
for i=length(fields(TrainingMov.Direction4))-4:length(fields(TrainingMov.Direction4))
    fname1=['Mff',num2str(i)];
...
for i=length(fields(BaseMov.Direction1))-4:length(fields(BaseMov.Direction1))
...
for i=length(fields(BaseMov.Direction2))-4:length(fields(BaseMov.Direction2))
...
for i=length(fields(BaseMov.Direction3))-4:length(fields(BaseMov.Direction3))
...
for i=length(fields(BaseMov.Direction4))-4:length(fields(BaseMov.Direction4))
