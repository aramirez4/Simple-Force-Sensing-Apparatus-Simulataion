...
for i=length(fields(TrainingMov.Direction1))-8:length(fields(TrainingMov.Direction1))
...
for i=length(fields(TrainingMov.Direction2))-5:length(fields(TrainingMov.Direction2))
    fname1=['Mff',num2str(i)];
...
for i=length(fields(TrainingMov.Direction3))-6:length(fields(TrainingMov.Direction3))
    fname1=['Mff',num2str(i)];
...
for i=length(fields(TrainingMov.Direction4))-5:length(fields(TrainingMov.Direction4))
    fname1=['Mff',num2str(i)];
